...
class ClientApi(BaseApi):
    def get_by_email(self, email: str) -> Client | None:
        ...
        Examples::
            ...
            client = api.client_api.get_by_email("email@example.com")
        """
    ...
    def get_ips(self, email: str) -> str | None:
        ...
        Examples::
            ...
            api = py3xui.Api.from_env()
            ips = api.client_api.get_ips("email@example.com")
        """
    ...
    def add(self, inbound_id: int, clients: list[Client]):
        ...
        Examples::
            ...
            api = py3xui.Api.from_env()
            clients = [py3xui.Client(...), py3xui.Client(...)]
    ...
    def online(self) -> list[str]:
        ...
        Examples::
            ...
            api = py3xui.Api.from_env()
            online_clients = api.client_api.online()
        """
